 ...
 */
export type WorkerOptionsWithDefaults = WorkerOptions & Required<Pick<WorkerOptions, 'namespace' | 'identity' | 'useVersioning' | 'shutdownGraceTime' | 'maxConcurrentActivityTaskExecutions' | 'maxConcurrentLocalActivityExecutions' | 'maxConcurrentWorkflowTaskExecutions' | 'maxConcurrentWorkflowTaskPolls' | 'maxConcurrentActivityTaskPolls' | 'enableNonLocalActivities' | 'stickyQueueScheduleToStartTimeout' | 'maxCachedWorkflows' | 'workflowThreadPoolSize' | 'maxHeartbeatThrottleInterval' | 'defaultHeartbeatThrottleInterval' | 'enableSDKTracing' | 'showStackTraceSources' | 'debugMode' | 'reuseV8Context'>> & {
    /**
